...
const columns = [
  ...
  },
  {
    title: "Company",
    links: [
      { href: "/about", label: "About Cimalc Tech" },
...
const linkClass =
  "w-fit text-sm text-muted transition-colors hover:text-brand focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand";
const pillClass =
  "inline-flex min-h-11 items-center gap-2 rounded-full border border-border px-4 text-xs font-medium text-default transition-colors hover:bg-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand";
      ...
      <div className="relative mx-auto max-w-[1440px] px-4 py-12 md:px-8 md:py-16">
        <div className="mb-14 flex flex-col justify-between gap-6 rounded-xl border border-border bg-background/70 p-5 backdrop-blur md:flex-row md:items-center md:p-7">
          <div>
            ...
            <p className="mt-2 max-w-xl text-sm leading-6 text-muted">
              Tell us what you need and our team will help you make a confident
              choice.
            </p>
          </div>
          <Link
            href="/contact"
            className="inline-flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-sm bg-brand px-5 text-sm font-semibold text-white transition-transform hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
          >
            Talk to our team{" "}
        ...
        <div className="grid gap-10 md:grid-cols-[1.3fr_2fr] md:gap-16">
          <div>
            <Link
              ...
              className="inline-flex w-fit focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
            >
              <SiteLogo className="h-16 w-16" sizes="128px" />
            </Link>
            <p className="mt-5 max-w-xs text-sm leading-6 text-muted">
              Thoughtfully selected electronics, personalized guidance, and
              quote-first buying.
            </p>
        ...
        <div className="mt-12 flex flex-col gap-3 border-t border-border pt-6 text-xs text-muted sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-5">
            ...
            <Link
              href="/admin"
              className="inline-flex min-h-9 w-fit items-center gap-2 rounded-full border border-border px-3 font-medium text-default transition-colors hover:border-brand/40 hover:text-brand focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
            >
